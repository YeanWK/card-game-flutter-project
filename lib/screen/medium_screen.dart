...
class MediumLevle extends StatefulWidget {
  const MediumLevle({super.key});

  @override
  State<MediumLevle> createState() => _MediumLevleState();
}

class _MediumLevleState extends State<MediumLevle>
                      ...
                      Container(
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            playMusic(1);
                            Navigator.pop(context);
                            ionicbondProvider.randomIonicbondMedium();
                            ionicbondProvider.randomAtomMedium();
                            setState(() {
                              isWon = false;
                              wrong = 0;
                              selectAtom.clear();
...
//ขยับขึ้นลง
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<IonicProvider>(builder: (context, valueProvider, child) {
      quizz = valueProvider.quizzMediumRandom;
      return Scaffold(
        body: SafeArea(
          child: Column(
            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: valueProvider.quizzMediumRandom
                                          .map((e) => Padding(
                                                padding:
  ...
  Widget buildCard() {
    var ionicbondProvider = context.read<IonicProvider>();
    if (ionicbondProvider.cardAtomMedium.length <= 8) {
      return SizedBox(
        width: 340,
        child: GridView.count(
          ...
          children: ionicbondProvider.cardAtomMedium.map((atom) {
            return InkWell(
    ...
    if (ionicbondProvider.cardAtomMedium.length <= 10) {
      return SizedBox(
        width: 212.5,
        child: GridView.count(
          padding: const EdgeInsets.only(top: 20),
